<template>
  <footer>
    ...
    <p style="text-align:center;color:white;">PRIVACY NOTE</p>
   
    <p style="text-align:center;color:white;">Generally the personal information we collect from you are for the purposes of dealing with your enquiry</p>
  
    <p style="text-align:center;color:white;">© 2022 REAL ESTATE - All rights reserved.</p>
  </footer>
</template>
