<template>
  <div id="home">
    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          <h3 class="mb-4 rounded"><a href="#start-shopping" class="bg-white px-2 py-2 rounded" id="heading">Start Investing</a></h3>
          <p id="content" class="lead mb-0 bg-dark p-1 rounded">New Era of Real Estate Investments: We Make Blockchain Benifits Accessible for Everyone via Fractional Ownership</p>
          <br>
          <br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-left">
          <h2 class="pt-3">Top Properties</h2>
        </div>
      </div>
      <div class="row">
